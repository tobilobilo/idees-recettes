...
const Button = ({ text, extraClasses, type, onClick = () => {}, expandable=false, singleClick=false, active=false, preIcon="", refresh=0, disabled=false }) => {
    ...
    const types = {
        ...
        linkcard: "uppercase bg-transparent text-stone-500 font-normal text-md w-full text-center rounded-none border-t border-stone-200 py-2 hover:bg-stone-100 disabled:text-stone-300 disabled:hover:bg-transparent",
