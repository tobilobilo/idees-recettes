...
const Navbar = () => {
    ...
    return ( 
        <div className="fixed w-64 h-screen top-0 left-0 -translate-x-64 transition duration-300 bg-white sm:bg-transparent sm:-translate-x-0 sm:translate-x-0 sm:relative sm:w-auto sm:h-auto" data-element="menu">
